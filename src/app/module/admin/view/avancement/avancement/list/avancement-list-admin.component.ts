...
export class AvancementListAdminComponent implements OnInit {

    protected fileName = 'Avancement';
    ...
    echelleAnciens: Array<EchelonDto>;
    echelleNouveaus: Array<EchelonDto>;


    constructor( private service: AvancementAdminService  , private echelonService: EchelonAdminService, private employeService: EmployeAdminService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    ngOnInit(): void {
        ...
        this.initCol();
        this.loadEmploye();
        this.loadEchelleAncien();
        this.loadEchelleNouveau();
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<AvancementDto>();
    ...
    public async edit(dto: AvancementDto) {
    ...
    public async view(dto: AvancementDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: AvancementDto) {
    ...
    public async duplicate(dto: AvancementDto) {
    ...
    public exportPdf(dto: AvancementDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'echelleAncien?.libelle', header: 'Echelle ancien'},
            {field: 'echelleNouveau?.libelle', header: 'Echelle nouveau'},
    ...
    public async loadEchelleAncien(){
        this.echelonService.findAllOptimized().subscribe(echelleAnciens => this.echelleAnciens = echelleAnciens, error => console.log(error))
    }
    public async loadEchelleNouveau(){
        this.echelonService.findAllOptimized().subscribe(echelleNouveaus => this.echelleNouveaus = echelleNouveaus, error => console.log(error))
    }


	public initDuplicate(res: AvancementDto) {
	}
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                ...
                'Echelle ancien': e.echelleAncien?.libelle ,
                'Echelle nouveau': e.echelleNouveau?.libelle ,
        ...
        //'Echelle ancien': this.criteria.echelleAncien?.libelle ? this.criteria.echelleAncien?.libelle : environment.emptyForExport ,
        //'Echelle nouveau': this.criteria.echelleNouveau?.libelle ? this.criteria.echelleNouveau?.libelle : environment.emptyForExport ,
    ...
    get selections(): Array<AvancementDto> {
        return this.service.selections;
    }

    set selections(value: Array<AvancementDto>) {
