...
@Component({
  selector: 'app-template-document-edit-admin',
  templateUrl: './template-document-edit-admin.component.html'
})
export class TemplateDocumentEditAdminComponent implements OnInit {
