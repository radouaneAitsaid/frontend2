...
@Component({
  selector: 'app-template-document-list-admin',
  templateUrl: './template-document-list-admin.component.html'
})
export class TemplateDocumentListAdminComponent implements OnInit {
