...
export class ResponsabiliteViewAdminComponent implements OnInit {
    ...
    constructor(private service: ResponsabiliteAdminService, private echelonService: EchelonAdminService){
