...
@Component({
  selector: 'app-responsabilite-detail-list-admin',
  templateUrl: './responsabilite-detail-list-admin.component.html'
})
export class ResponsabiliteDetailListAdminComponent implements OnInit {
