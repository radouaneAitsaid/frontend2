...
@Component({
  selector: 'app-responsabilite-detail-view-admin',
  templateUrl: './responsabilite-detail-view-admin.component.html'
})
export class ResponsabiliteDetailViewAdminComponent implements OnInit {
    ...
    constructor(private service: ResponsabiliteDetailAdminService, private responsabiliteService: ResponsabiliteAdminService){
