...
@Component({
  selector: 'app-responsabilite-detail-edit-admin',
  templateUrl: './responsabilite-detail-edit-admin.component.html'
})
export class ResponsabiliteDetailEditAdminComponent implements OnInit {
