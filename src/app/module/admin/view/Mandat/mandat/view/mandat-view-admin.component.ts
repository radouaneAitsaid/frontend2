...
export class MandatViewAdminComponent implements OnInit {
    ...
    constructor(private service: MandatAdminService, private responsabiliteService: ResponsabiliteAdminService, private employeService: EmployeAdminService){
