...
@Component({
  selector: 'app-template-document-view-employe',
  templateUrl: './template-document-view-employe.component.html'
})
export class TemplateDocumentViewEmployeComponent implements OnInit {
    ...
    constructor(private service: TemplateDocumentEmployeService, private typeDocumentService: TypeDocumentEmployeService){
