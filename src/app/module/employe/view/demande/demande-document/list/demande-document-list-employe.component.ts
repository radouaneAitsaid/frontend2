...
@Component({
  selector: 'app-demande-document-list-employe',
  templateUrl: './demande-document-list-employe.component.html'
})
export class DemandeDocumentListEmployeComponent implements OnInit {

    protected fileName = 'DemandeDocument';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<DemandeDocumentDto>();
    ...
    public async edit(dto: DemandeDocumentDto) {
    ...
    public async view(dto: DemandeDocumentDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: DemandeDocumentDto) {
    ...
    public async duplicate(dto: DemandeDocumentDto) {
    ...
    public exportPdf(dto: DemandeDocumentDto): void {
...
// add
	...
	public initDuplicate(res: DemandeDocumentDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<DemandeDocumentDto> {
        return this.service.selections;
    }

    set selections(value: Array<DemandeDocumentDto>) {
