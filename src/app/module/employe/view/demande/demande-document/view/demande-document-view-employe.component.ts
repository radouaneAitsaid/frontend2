...
@Component({
  selector: 'app-demande-document-view-employe',
  templateUrl: './demande-document-view-employe.component.html'
})
export class DemandeDocumentViewEmployeComponent implements OnInit {
    ...
    constructor(private service: DemandeDocumentEmployeService, private employeService: EmployeEmployeService, private typeDocumentService: TypeDocumentEmployeService){
