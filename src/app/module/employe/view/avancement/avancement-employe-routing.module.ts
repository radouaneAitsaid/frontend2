                    ...
                    children: [
...

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: EchelonListEmployeComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: AvancementListEmployeComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: EchelleListEmployeComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },
...
export class AvancementEmployeRoutingModule { }
