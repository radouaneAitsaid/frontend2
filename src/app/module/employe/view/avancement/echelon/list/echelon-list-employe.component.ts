...
@Component({
  selector: 'app-echelon-list-employe',
  templateUrl: './echelon-list-employe.component.html'
})
export class EchelonListEmployeComponent implements OnInit {

    protected fileName = 'Echelon';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<EchelonDto>();
    ...
    public async edit(dto: EchelonDto) {
    ...
    public async view(dto: EchelonDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: EchelonDto) {
    ...
    public async duplicate(dto: EchelonDto) {
    ...
    public exportPdf(dto: EchelonDto): void {
...
// add
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<EchelonDto> {
        return this.service.selections;
    }

    set selections(value: Array<EchelonDto>) {
