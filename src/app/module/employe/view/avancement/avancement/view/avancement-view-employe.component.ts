...
@Component({
  selector: 'app-avancement-view-employe',
  templateUrl: './avancement-view-employe.component.html'
})
export class AvancementViewEmployeComponent implements OnInit {
    ...
    constructor(private service: AvancementEmployeService, private echelonService: EchelonEmployeService, private employeService: EmployeEmployeService){
