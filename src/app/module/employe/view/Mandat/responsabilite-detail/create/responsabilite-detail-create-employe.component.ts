...
@Component({
  selector: 'app-responsabilite-detail-create-employe',
  templateUrl: './responsabilite-detail-create-employe.component.html'
})
export class ResponsabiliteDetailCreateEmployeComponent  implements OnInit {
