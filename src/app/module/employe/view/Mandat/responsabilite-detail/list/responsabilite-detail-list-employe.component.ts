...
@Component({
  selector: 'app-responsabilite-detail-list-employe',
  templateUrl: './responsabilite-detail-list-employe.component.html'
})
export class ResponsabiliteDetailListEmployeComponent implements OnInit {

    protected fileName = 'ResponsabiliteDetail';
    ...
    constructor( private service: ResponsabiliteDetailEmployeService  , private responsabiliteService: ResponsabiliteEmployeService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ResponsabiliteDetailDto>();
    ...
    public async edit(dto: ResponsabiliteDetailDto) {
    ...
    public async view(dto: ResponsabiliteDetailDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ResponsabiliteDetailDto) {
    ...
    public async duplicate(dto: ResponsabiliteDetailDto) {
    ...
    public exportPdf(dto: ResponsabiliteDetailDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'responsabilite?.nom', header: 'Responsabilite'},
        ];
    }
	...
	public initDuplicate(res: ResponsabiliteDetailDto) {
	}
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                ...
                'Date application max': this.datePipe.transform(e.dateApplicationMax , 'dd/MM/yyyy hh:mm'),
                 'Salaire': e.salaire ,
                'Responsabilite': e.responsabilite?.nom ,
            }
        });
        ...
        //'Responsabilite': this.criteria.responsabilite?.nom ? this.criteria.responsabilite?.nom : environment.emptyForExport ,
        }];
      }
    ...
    get selections(): Array<ResponsabiliteDetailDto> {
        return this.service.selections;
    }

    set selections(value: Array<ResponsabiliteDetailDto>) {
