...
@Component({
  selector: 'app-mandat-list-employe',
  templateUrl: './mandat-list-employe.component.html'
})
export class MandatListEmployeComponent implements OnInit {

    protected fileName = 'Mandat';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<MandatDto>();
    ...
    public async edit(dto: MandatDto) {
    ...
    public async view(dto: MandatDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: MandatDto) {
    ...
    public async duplicate(dto: MandatDto) {
    ...
    public exportPdf(dto: MandatDto): void {
...
// add
	...
	public initDuplicate(res: MandatDto) {
	}
   ...
   public prepareColumnExport(): void {
    ...
    get selections(): Array<MandatDto> {
        return this.service.selections;
    }

    set selections(value: Array<MandatDto>) {
