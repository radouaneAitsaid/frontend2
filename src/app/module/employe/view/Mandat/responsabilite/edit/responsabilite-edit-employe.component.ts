...
@Component({
  selector: 'app-responsabilite-edit-employe',
  templateUrl: './responsabilite-edit-employe.component.html'
})
export class ResponsabiliteEditEmployeComponent implements OnInit {
