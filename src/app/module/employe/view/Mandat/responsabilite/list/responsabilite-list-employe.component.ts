...
export class ResponsabiliteListEmployeComponent implements OnInit {

    protected fileName = 'Responsabilite';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ResponsabiliteDto>();
    ...
    public async edit(dto: ResponsabiliteDto) {
    ...
    public async view(dto: ResponsabiliteDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ResponsabiliteDto) {
    ...
    public async duplicate(dto: ResponsabiliteDto) {
    ...
    public exportPdf(dto: ResponsabiliteDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'echelonMin?.libelle', header: 'Echelon min'},
        ];
    }


    public async loadEchelonMin(){
        this.echelonService.findAllOptimized().subscribe(echelonMins => this.echelonMins = echelonMins, error => console.log(error))
    }


	public initDuplicate(res: ResponsabiliteDto) {
	}
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                 'Ref': e.ref ,
                 'Nom': e.nom ,
                'Echelon min': e.echelonMin?.libelle ,
            }
        });
        ...
        //'Echelon min': this.criteria.echelonMin?.libelle ? this.criteria.echelonMin?.libelle : environment.emptyForExport ,
        }];
      }
    ...
    get selections(): Array<ResponsabiliteDto> {
        return this.service.selections;
    }

    set selections(value: Array<ResponsabiliteDto>) {
