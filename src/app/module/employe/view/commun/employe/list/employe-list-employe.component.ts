...
export class EmployeListEmployeComponent implements OnInit {

    protected fileName = 'Employe';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<EmployeDto>();
    ...
    public async edit(dto: EmployeDto) {
    ...
    public async view(dto: EmployeDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: EmployeDto) {
    ...
    public async duplicate(dto: EmployeDto) {
    ...
    public exportPdf(dto: EmployeDto): void {
...
// add
    ...
    public async loadDiplome(){
        this.diplomeService.findAllOptimized().subscribe(diplomes => this.diplomes = diplomes, error => console.log(error))
    }
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                ...
                'Entite admin': e.entiteAdmin?.departement ,
            }
        });
       ...
       this.criteriaData = [{
           ...
           //'Diplome': this.criteria.diplome?.libelle ? this.criteria.diplome?.libelle : environment.emptyForExport ,
           //'Entite admin': this.criteria.entiteAdmin?.departement ? this.criteria.entiteAdmin?.departement : environment.emptyForExport ,
       }];
      }
    ...
    get selections(): Array<EmployeDto> {
        return this.service.selections;
    }

    set selections(value: Array<EmployeDto>) {
