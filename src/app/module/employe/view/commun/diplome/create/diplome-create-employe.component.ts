...
@Component({
  selector: 'app-diplome-create-employe',
  templateUrl: './diplome-create-employe.component.html'
})
export class DiplomeCreateEmployeComponent  implements OnInit {
   ...
   private _validDiplomeLibelle = true;
	...
	constructor(private service: DiplomeEmployeService , private echelonService: EchelonEmployeService, @Inject(PLATFORM_ID) private platformId? ) {
