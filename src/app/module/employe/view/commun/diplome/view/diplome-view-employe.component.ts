...
@Component({
  selector: 'app-diplome-view-employe',
  templateUrl: './diplome-view-employe.component.html'
})
export class DiplomeViewEmployeComponent implements OnInit {
    ...
    constructor(private service: DiplomeEmployeService, private echelonService: EchelonEmployeService){
