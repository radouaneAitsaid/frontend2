...
export class EntiteAdminViewEmployeComponent implements OnInit {
    ...
    constructor(private service: EntiteAdminEmployeService, private diplomeService: DiplomeEmployeService, private employeService: EmployeEmployeService){
